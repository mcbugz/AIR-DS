...
This repo uses a closed-world design system: 21 component exports from `@ds/react` and 229 `--ds-*` tokens, all enumerated in generated registries. Anything not in a registry does not exist. Your training data about this system is stale or empty — retrieve, don't recall.
